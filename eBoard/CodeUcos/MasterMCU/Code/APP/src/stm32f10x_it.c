...
* Description    : This function handles DMA1_Channel4 global interrupt request.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
* Description    : This function handles DMA1_Channel5 global interrupt request.
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
...
{
	USART_ClearFlag(USART1,USART_FLAG_RXNE|USART_FLAG_FE|USART_FLAG_PE);
	//UartHandle();
